...
\extrainfo{
    \faEnvelope~\href{1ssb.rudra@gmail.com}{1ssb.rudra@gmail.com} ~~~
    \faGithub~\githublink ~~~
...
\cventry{April 2023-Present}{Research School of Computing, Australian National University}{Doctor of Philosophy in Artificial Intelligence}{Ongoing}{Australia}{
  ...
  \textbullet Specialisations: Vision Language Models, Non-Convex Optimization, Diffusion Models \& 3D Computer Vision\\
  \textbullet Attended: Robotic Vision Summer School, 2024; Optiver PhD Quant Lab Program, 2024 (Acceptance rate 6\%)\\
  \textbullet Participated by invitation to the all-paid PhD summit by Citadel \& Citadel Securities, London (Acceptance rate 4.8\%)\\
...
\cventry{July 2018 - Dec 2022}{College of Systems \& Society, Australian National University}{Bachelor of Engineering}{First Class, Honours}{Australia}{
  ...
  \textbullet Thesis Project: Whiplash Gradient Descent Dynamics (Supervisor: Professor Ian Petersen).\\
...
\begin{itemize}[leftmargin=*, itemsep=0em]
    \item \textbf{Programming Languages \& Scripting:} Python, C, CUDA-Python, R, Embedded C, MATLAB, HTML-CSS-JavaScript
    \item \textbf{ML libraries:} PyTorch, Scikit-learn, Pandas, NumPy, Numba, SciPy, Seaborn, Matplotlib, Jupyter, OpenCV, OpenGL, Transformers, CuPy, XGBoost, LightGBM, Dask, W\&B, Optuna, NLTK
